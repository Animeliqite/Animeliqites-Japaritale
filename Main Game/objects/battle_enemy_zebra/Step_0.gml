...
if(_phase==0){
	...
	if(_subPhase==0){
		...
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.0"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.1"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.3"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(0, battle_dialog_enemy);
		C_Wait(1, 1);
		...
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.4"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(2, battle_dialog_enemy);
		C_Execute(3, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_sad]);
		C_Execute(3, BGM_Pause, [5]);
		C_Execute(3, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.5"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(4, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.6"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(5, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.7"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(6, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.8"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(7, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.9"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(0, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(0, variable_instance_set, [object_index, "shakeAmountFake", 2]);
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.3.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(0, battle_dialog_enemy);
		C_Wait(1, 1);
		C_Execute(2, variable_instance_set, [object_index, "shakeAmountFake", 0]);
		C_Execute(2, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.4.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(2, battle_dialog_enemy);
		C_Execute(3, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_sad]);
		C_Execute(3, BGM_Pause, [5]);
		C_Execute(3, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.5.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(3, battle_dialog_enemy);
		C_Execute(4, BGM_Resume, [5]);
		C_Execute(4, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(4, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.6.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(4, battle_dialog_enemy);
		C_Execute(5, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(5, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.7.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(5, battle_dialog_enemy);
		C_Execute(5, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_happy]);
		C_Execute(6, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.8.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(6, battle_dialog_enemy);
		...
		C_Execute(0, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.1.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(0, battle_dialog_enemy);
		C_FadeFader(1, 1, 0, 15, 0, c_white);
		C_Execute(1, variable_instance_set, [object_index, "showHealthbar", true]);
		C_Execute(1, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal_idle]);
		...
		C_Execute(0, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(0, variable_instance_set, [object_index, "shakeAmountFake", 2]);
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.3.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(0, battle_dialog_enemy);
		C_Wait(1, 1);
		C_Execute(2, variable_instance_set, [object_index, "shakeAmountFake", 0]);
		C_Execute(2, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.4.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(2, battle_dialog_enemy);
		C_Execute(3, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_sad]);
		C_Execute(3, BGM_Pause, [5]);
		C_Execute(3, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.5.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(3, battle_dialog_enemy);
		C_Execute(4, BGM_Resume, [5]);
		C_Execute(4, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(4, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.6.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(4, battle_dialog_enemy);
		C_Execute(5, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_normal]);
		C_Execute(5, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.7.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(5, battle_dialog_enemy);
		C_Execute(6, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(6, variable_instance_set, [object_index, "shakeAmountFake", 2]);
		C_Execute(6, variable_instance_set, [object_index, "partCreatedOnce", false]);
		C_Execute(6, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.8.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(6, battle_dialog_enemy);
		C_Execute(7, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.9.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(7, battle_dialog_enemy);
		...
		C_Execute(8, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.10.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		...
		C_Execute(0, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(0, variable_instance_set, [object_index, "shakeAmountFake", 2]);
		C_Execute(0, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.3.alt.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(0, battle_dialog_enemy);
		C_Wait(1, 1);
		C_Execute(2, variable_instance_set, [object_index, "shakeAmountFake", 2]);
		C_Execute(2, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.4.alt.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(2, battle_dialog_enemy);
		...
		C_Execute(3, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.5.alt.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(3, battle_dialog_enemy);
		C_Execute(4, variable_instance_set, [object_index, "shakeAmountFake", 4]);
		C_Execute(4, variable_instance_set, [object_index, "sprite_index", spr_zebra_monster_ask]);
		C_Execute(4, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.6.alt.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(4, battle_dialog_enemy);
		...
		C_Execute(5, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.7.alt.alt.alt"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(5, battle_dialog_enemy);
		...
		C_Execute(1, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.end.0"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(1, battle_dialog_enemy);
		C_Execute(2, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.end.1"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(2, battle_dialog_enemy);
		C_Execute(3, Battle_CreateBubble, [Lang_GetString("cutscene.zebra.conversation.end.2"), "{effect -1}", 80, -(sprite_height / 1.5), 2]);
		C_WaitUntilDestroy(3, battle_dialog_enemy);
