...
if(!instance_exists(target)){
	...
	x=median(0, (target.x-(width/scale_x/2))*offset_amount_x, room_width-(width/scale_x))+_shake_pos_x;
	y=median(0, (target.y-(width/scale_x/2))*offset_amount_y, room_height-(height/scale_y))+_shake_pos_y;
